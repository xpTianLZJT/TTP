...
>
![图5 基于列的对齐方案图示](./figure/5.png)
<center>图5 基于列的对齐方案图示</center>
...
## 分支定价算法
众所周知，列生成通常仅能得到原问题的线性松弛解，需要进一步结合分支定界来搜索整数解。在每个分支节点，利用列生成算法获得它的最优松弛解（记为下界），如果此下界大于当前最优上界，则对节点进行修剪；否则，进一步分支。此外，本文采用深度优先策略探索分支节点。
### 分支策略
